  ...
  fluidPage(
    ...
    fluidRow(
      ...
      column(
        ...
        div(
          "First Player Kill",
          style = "color: var(--lol-gold); text-align: center; font-size: 1.4em; margin-bottom: 15px; font-weight: bold;"
        ),
        div(
    ...
    fluidRow(
      column(
        ...
        align = "center",
        div(
          style = "display: flex; align-items: center; justify-content: center; height: 100%; margin-top: 25px; margin-bottom: 25px;",
...
data_upload_ui <- tabPanel(
  ...
  fluidRow(
    column(
      ...
      offset = 2,
      div(
        style = "background-color: rgba(0, 50, 78, 0.9); color: var(--lol-gold); padding: 20px 20px 0px 20px; border-radius: 15px; border: 1px solid var(--lol-gold); margin-bottom: 25px;",
        tags$label(
          "Choose a CSV file",
          `for` = "file",
          style = "color: var(--lol-gold); font-size: 1.2em; font-weight: bold; margin-bottom: 10px; display: block;"
        ),
        div(
          style = "width: 100%;",
          fileInput(
  ...
  fluidRow(
    column(
      ...
      div(
        ...
        h4(
          "Train/Test split",
          style = "color: var(--lol-gold); font-weight: bold;"
        ),
        div(
          style = "display: flex; align-items: center; justify-content: space-between;; color: var(--lol-gold); text-align: left; width: 100%;",
          h5(
            "Training data percentage",
            style = "color: var(--lol-gold); text-align: left;"
          ),
          h5(
            "Testing data percentage",
            style = "color: var(--lol-gold); text-align: right;"
          ),
        ),
        sliderInput(
          "train_test_split",
  ...
  fluidRow(
    column(8, offset = 2, align = "center", uiOutput("train_display_wrapper"))
  ),
  fluidRow(
    column(
      8,
...
presentaion_ui <- tabPanel(
  ...
  fluidPage(
    ...
    div(
      ...
      fluidRow(
        tags$h2(
          "Predicting outcome of League of Legends game by early game",
        ...
        column(
          ...
          tags$h3(
            ...
            style = "margin-top: 20px; color: var(--lol-gold);"
          ),
          ...
          tags$ul(
            ...
            tags$li(
              "Created a \"snapshot\" of early game",
              tags$ul(
        ...
        column(
          6,
          offset = 1,
          tags$img(src = "lol-map.ppm", width = "512px", alt = "LoL map")
        )
      )
    ),
        ...
        column(
          ...
          tags$ul(
            tags$li(
              "Achieving some",
              tags$i("first event"),
              "team has only around 60% of winning"
            ),
            tags$li(tags$b("SISO sign #2")),
            tags$li(
              tags$i("first_tower"),
              "has the highest chance, but doesn't happen much"
            ),
      ...
      fluidRow(
        column(
          ...
          tags$ul(
            ...
            tags$li(
              tags$i("dragon_diff & first_dragon"),
              "- missing cases",
              tags$ul(
                tags$li("no significant boost in win rate"),
              ),
            ...
            tags$li(
              tags$i("rift_herald_diff & first_herald"),
              "- missing cases"
            ),
            tags$li(
              tags$i("tower_diff & first_tower"),
              "- didn't happen in majority of games"
            ),
    ...
    div(
      ...
      fluidRow(
        column(
          ...
          tags$li(
            "Most important LoL game metrics (gold, minion kills, experience) aren't in our dataset"
          ),
