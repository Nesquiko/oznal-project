---
title: "CASTVEN KILIAN CAPSTONE PROJECT"
...
All code and data can be accessed through [our github repository](https://github.com/Nesquiko/oznal-project).
...
The original dataset didn't include champion classifications like 'Fighter', 'Mage', etc. and we think it might help.
...
We first try all features that show promise in EDA (`first_` and diffs).
